...
export function ProgramDetailNav({ tabs }: { tabs: ProgramDetailNavTab[] }) {
  ...
  return (
    <nav
      ...
      className="sticky top-[70px] z-30 flex h-[33px] w-full items-center gap-[21px] overflow-x-auto border-y-[0.5px] border-[#F5E1D3] bg-white/95 pt-1.5 backdrop-blur [scrollbar-width:none] [&::-webkit-scrollbar]:hidden max-[1099px]:top-[56px] max-[1099px]:h-11 max-[1099px]:gap-2 max-[1099px]:pt-0"
    >
      {tabs.map((tab) => {
        ...
        return (
          <a
            ...
            className={`relative inline-flex h-[27px] min-w-[55px] shrink-0 items-center justify-center whitespace-nowrap text-xs max-[1099px]:h-11 max-[1099px]:px-2 ${
              isActive
