...
export const hostWorkspaceScaleStyle = {
  ...
  "--host-51": "clamp(51px, 3.542vw, 68px)",
  ...
  "--host-65": "clamp(65px, 4.514vw, 86.667px)",
  ...
  "--host-127": "clamp(127px, 8.819vw, 169.333px)",
  "--host-128": "clamp(128px, 8.889vw, 170.667px)",
  "--host-129": "clamp(129px, 8.958vw, 172px)",
  "--host-132": "clamp(132px, 9.167vw, 176px)",
  ...
  "--host-360": "clamp(360px, 25vw, 480px)",
  ...
  "--host-575": "clamp(575px, 39.931vw, 766.667px)",
  ...
  "--host-760": "clamp(760px, 52.778vw, 1013.333px)",
  "--host-765": "clamp(765px, 53.125vw, 1020px)",
  "--host-780": "clamp(780px, 54.167vw, 1040px)",
