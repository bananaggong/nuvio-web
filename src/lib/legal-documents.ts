...
export const legalDocuments: Record<LegalDocumentKey, LegalDocument> = {
  terms: {
    key: "terms",
    title: "이용약관",
    description: "그린티모시레 서비스 이용조건과 운영에 관한 약관입니다.",
    href: "/terms",
    content: `제1조 목적

본 이용약관은 “그린티모시레”(이하 "그린티모시레")의 서비스의 이용조건과 운영에 관한 제반 사항 규정을 목적으로 합니다.
...
이 약관은 <사이트 개설일>부터 시행합니다`,
  ...
  privacyCollection: {
    ...
    title: "개인정보 수집 및 이용",
    description: "그린티모시레 서비스 이용을 위한 개인정보 수집 및 이용 동의입니다.",
    href: "/privacy",
...
회원탈퇴 시까지 (단, 관계 법령에 보존 근거가 있는 경우 해당 기간 시까지 보유, 개인정보처리방침에서 확인 가능)`,
  ...
  thirdParty: {
    ...
    description: "그린티모시레 서비스의 개인정보 제3자 제공 동의입니다.",
    href: "/privacy/third-party",
    content: `다음과 같이 개인정보를 제3자에게 제공하고 있습니다.
