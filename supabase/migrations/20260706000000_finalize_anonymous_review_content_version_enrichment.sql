-- Finalize anonymous review content-version enrichment after the first application-service pass.
-- Token-based participant reviews do not always have an actor id, so changed_by
-- alone is not enough to prove that enrichment has already happened.
